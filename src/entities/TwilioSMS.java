...
public class TwilioSMS {
    ...
    public void sendSmsSync(String phone, String fromPhone, String body) {
        Response<Map> value = Rest.post("https://api.twilio.com/2010-04-01/Accounts/" + "ACb6f469cc427a1d8ecbfee4779793b6d5" + 
                    "/Messages.json").
                queryParam("To", phone).
                queryParam("From", fromPhone).
                queryParam("Body", body).
                header("Authorization", "Basic " + Base64.encodeNoNewline(("ACb6f469cc427a1d8ecbfee4779793b6d5" + ":" + "096dce955f3e1835ce3535071179eab5").getBytes())).
                getAsJsonMap();
