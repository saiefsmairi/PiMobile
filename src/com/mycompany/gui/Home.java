...
public class Home extends BaseForm {
    ...
    { super("",BoxLayout.y());
     ...
     //setTitle("welcome to Oxyvia Tours Agency");
     //setColor(0x1e3642);
      ...
      add(lreturn);
        addTab(swipe,s1, res.getImage("flat-lay-composition-tourist-items-notebook-color-background-space-text-travel-agency-144306858.jpg"),"","",res);
        ...
        //mesListes.getStyle().setFgColor(0x1e3642);
         //mesListes.getStyle().setFgColor(0xf21f1f);
         mesListes.addPointerPressedListener(l ->{
     // new ListFactureForm(res).show();
    
    });
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Travels", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Events", barGroup);
        partage.setUIID("SelectBar");
        RadioButton home = RadioButton.createToggle("payment", barGroup);
         home.addPointerPressedListener(l ->{
        new AjoutFactureForm(res).show();
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(4, mesListes, liste, partage,home),
        ...
        //add(sl);
        Label ll =new Label("BOOK UNIQUE EXPERIENCES\n" +
          "Expolore top rated tours, hotels and restaurants around the world");
              Label l2 =new Label("Expolore top rated tours, hotels and restaurants around the world");
               Label l3 =new Label("                                  ");
                Label l4 =new Label("                                    ");
                 Label l5 =new Label("                                                  ");
                 Label l6 =new Label("                                                  ");
                 ...
                 Label l9 =new Label("                                                  ");
                 Label l10 =new Label("                                                  ");
        ll.getStyle().setFgColor(0x1e3642);
        Font smallPlainSystemFont = Font.createSystemFont(Font.FACE_SYSTEM, Font.STYLE_BOLD, Font.SIZE_LARGE);
        ll.getStyle().setFont(smallPlainSystemFont);
        
       
        add(LayeredLayout.encloseIn(
                sl,
                BorderLayout.south(
                    GridLayout.encloseIn(ll,l2,l3,l4,l5,l6,l7,l8,l9,l10
    ...
    private void addTab(Tabs swipe, Label spacer ,Image image, String string, String text, Resources res) {
        ...
        swipe.addTab("",res.getImage("flat-lay-composition-tourist-items-notebook-color-background-space-text-travel-agency-144306858.jpg"),page1);
    }
