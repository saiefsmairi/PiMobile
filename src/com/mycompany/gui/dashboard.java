...
public class dashboard extends BaseForm{
    ...
    { super("Adminstration Space",BoxLayout.y());
     ...
     // setTitle("Payment");
      getContentPane().setScrollVisible(false);
        ...
        RadioButton mesListes = RadioButton.createToggle("Facts£", barGroup);
      ...
      new ListFactureForm(res).show();
        ...
        RadioButton partage = RadioButton.createToggle("Hotels", barGroup);
      ...
      Image img = res.getImage("images.jpg");
        ...
        //add(sl);
        Label ll =new Label("  ADMINSTRATION SPACE \n" );
              Label l2 =new Label("                                                ");
               Label l3 =new Label("                                  ");
                Label l4 =new Label("                                    ");
                 Label l5 =new Label("                                                  ");
    ...
    private void addTab(Tabs swipe, Label spacer ,Image image, String string, String text, Resources res) {
        ...
        swipe.addTab("",res.getImage("Capture.PNG"),page1);
    }
