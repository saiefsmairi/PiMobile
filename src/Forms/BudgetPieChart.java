...
public class BudgetPieChart extends AbstractDemoChart {
   ...
   */
  public Form execute() {
    double[] values = new double[] { 12, 14, 11, 10, 69 };
    ...
    ReservationService rs=new ReservationService();
	 List<Resstats>lst1=rs.getInstance().getAllTasks3();

	 for (Resstats value : lst1) {
System.out.println(value.getNomh());	    }
	 
    final CategorySeries seriesSet = buildCategoryDataset("Reservation Stats", lst1);
