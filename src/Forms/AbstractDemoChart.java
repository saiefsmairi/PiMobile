...
public abstract class AbstractDemoChart implements IDemoChart {
   ...
   * 
   * @param titles the series titles
   * @param lst1 the values
   * @return the category series
   */
  protected CategorySeries buildCategoryDataset(String nomh, List<Resstats> lst1) {
    CategorySeries series = new CategorySeries(nomh);
    int k = 0;
    
    for (Resstats value : lst1) {
      series.add("Hotel " + value.getNomh(), value.getNbres());
    }
